...
export default function CounsellingDetailPage({ id }: { id: string }) {
        ...
        <div className="min-h-screen bg-background pb-16">
            <div className="max-w-[1400px] mx-auto px-6 py-6">
                ...
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <button
                        onClick={() => router.back()}
                        className="flex items-center justify-center w-8 h-8 rounded-lg border border-border hover:bg-muted transition"
                    >
                        <ArrowLeft size={16} />
                    </button>
